"""
Django settings for ZepterPortal project.
...
SECRET_KEY = 'django-insecure-iqi!p@akhqz7&5p99w$=*ms_x_8alqo*1z8mu(*gnhu)1@e=mb'
...
ROOT_URLCONF = 'ZepterPortal.urls'
...
WSGI_APPLICATION = 'ZepterPortal.wsgi.application'
